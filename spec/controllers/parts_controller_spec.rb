  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Part" do
        expect do
          post :create, params: { part: valid_attributes }, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: { part: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested part" do
        part = Part.create! valid_attributes
        put :update, params: { id: part.to_param, part: new_attributes }, session: valid_session
        part.reload
      ...
      it "redirects to the part" do
        part = Part.create! valid_attributes
        put :update, params: { id: part.to_param, part: valid_attributes }, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        part = Part.create! valid_attributes
        put :update, params: { id: part.to_param, part: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
